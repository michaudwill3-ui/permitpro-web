...
<div class="footer">Generated by PermitPro — Always verify with local authorities before starting work.</div>
</body></html>`;
        ...
        {screen === "results" && checklist && (
          <div style={{ display: "flex", gap: 10 }}>
            <button onClick={() => doPrint(trade, job, state, city, checklist.safetyAlerts, checklist.permits, materials)}
              style={{ background: "#111", border: "1px solid #444", color: "#fff", borderRadius: 6, padding: "8px 14px", fontSize: 12, fontWeight: 700, cursor: "pointer", letterSpacing: "0.04em" }}>
              🖨 Print
            </button>
            <button onClick={() => {
